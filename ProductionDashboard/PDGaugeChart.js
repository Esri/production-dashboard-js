...
*/
 ...
 "dojo/domReady!"
 	...
 	return declare("esri.productiondashboard.PDGaugeChart",[PDChart], {
 		
    	svgType                     : PDChartEnum.GAUGE_CHART,        
        ...
        _prepareGaugeData: function(data, scale){
            ...
            if (this.data.length == 1){
                 ...
                 gaugeData.value = gaugeData.value.toFixed(2);
            } else{
                var sum  = data.reduce(function(sum, a) {return sum + a.d ;} ,0);
