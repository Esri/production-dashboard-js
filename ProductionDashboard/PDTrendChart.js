 ...
 */
 ...
 "dojo/domReady!"
 	...
 	return declare("esri.productiondashboard.PDTrendChart",[PDChart], {
 		svgType                 : PDChartEnum.TREND_CHART,    	
        ...
        _visualizeTrendChart: function(){
            ...
            var minLeftMargin = Math.round(0.3 * trendData.longestLabelLength * minHAxesFontSize + 0.6 * minHAxesFontSize);
